...
object TaskHelper {
    ...
    suspend fun startCheckFromList(context: Context, list: List<String>) {
    ...
    suspend fun getUserList(context: Context, isBack2App: Boolean = false): List<String> {
    ...
    suspend fun quickCheck(context: Context) {
